                        ...
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     ...
                                     <a href="index.php"><img src="images/logo/NiamhLogo.jpg" alt="logo images"></a>
                                </div>
                            </div>
                            <div class="col-md-7 col-lg-8 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        <!-- <li class="drop"><a href="index.php" onclick="prompt('Enter Your Email ID');">Home</a></li> -->
                                        <li class="drop"><a href="index.php">Home</a></li>
                                        <!-- <li class="drop" onlick="click()"><a href="#">Shop</a></li> -->
                                        <!-- <a href="#" onclick="alert('I am a popup!');">Link</a> -->
                                        <li class="drop" onclick="alert('Shopping Comming Soon');"><a href="#">Shop</a></li>
                                ...
                                <div class="mobile-menu clearfix visible-xs visible-sm">
                                    <nav id="mobile_dropdown">
                                        <ul>
                                            ...
                                            <!-- <li><a href="#">Shop</a></li> -->
                                            <li><a href="#" onclick="alert('Shopping Comming Soon');">Shop</a></li>
                            ...
                            <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="header__account">
                                        <a href="#" onclick="alert('Login Comming Soon');">Login</a>
                                    </div>
                                    <div class="htc__shopping__cart">
                                        <a class="cart__menu" href="#"><i class="icon-handbag icons"></i></a>
                                        <a href="#" onclick="alert('Shopping Comming Soon');"><span class="htc__qua">2</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
